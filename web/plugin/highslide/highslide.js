...
Biên dịch & thay đổi： Hà Xuân Thành
Trang chủ：http://xuanthanh.net
******************************************************************************/

var hs = {
// Language strings
lang : {
	cssDirection: 'ltr',   //Không thay đổi！！！
	loadingText : 'Đang tải...',
	loadingTitle : 'Hủy bỏ',
	focusTitle : 'Click để xem ảnh',
	fullExpandTitle : 'Kích thước ảnh đầy đủ (Nhấn F)',
	creditsText : '<i>Liên kết</i>',//Vui lòng thay đổi các biểu tượng！
	creditsTitle : 'Trang chủ',
	previousText : 'Ảnh trước',
	nextText : 'Ảnh sau', 
	moveText : 'Di chuyển',
	closeText : 'Đóng', 
	closeTitle : 'Đóng ảnh (Nhấn ESC)', 
	resizeTitle : 'Điều chỉnh',
	playText : 'Chạy',
	playTitle : 'Chạy (Nhấn SPACEBAR)',
	pauseText : 'Dừng',
	pauseTitle : 'Tạm dừng (Nhấn SPACEBAR)',
	previousTitle : 'Ảnh trước (Phím mũi tên bên trái)',
	nextTitle : 'Ảnh sau (Phím mũi tên bên phải)',
	moveTitle : 'Di chuyển',
	fullExpandText : 'Kích thước ảnh đầy đủ',
	number: 'Hình ảnh 1 hoặc 2',
	restoreTitle : 'Click để đóng, Nhấp và rê chuột để di chuyển, Sử dụng phím mũi tên để hiển thị ảnh trước hoặc sau'
},
...
creditsHref : 'http://xuanthanh.net', // Logo liên kết
